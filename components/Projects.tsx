...
const projects =[
    {
        ...
        "img": sgImg,
        "desc": "MERN Full Stack application for tracking goals between authorized users with openAI chatGPT integration.",
      ...
      },
      {
        ...
        "desc": "NextJs frontend application integrated with openAI chatGPT built to support parents with children with special needs by tracking behavioral data.",
        "img": behaviorImg,
...
const Projects = () => {
    return (  
        <section id="projects">
            <h1 className="font-serif text-center font-bold text-4xl">Check Out My Work!
